...
class DataSet(FourcatModule):
	...
	def iterate_items(self, processor=None, bypass_map_item=False, subfile=None, warn_unmappable=True):
		"""
	...
	def iterate_subfile(self, subfile, processor=None, bypass_map_item=False):
		...
		self.iterate_items(self, processor, bypass_map_item, subfile=subfile)
